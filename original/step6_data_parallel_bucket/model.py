...
from flash_attn.layers.rotary import apply_rotary_emb  # CPU/MPS NOTE: Use a pure PyTorch rotary helper for CPU/MPS execution.
from flash_attn.ops.triton.layer_norm import layer_norm_fn  # CPU/MPS NOTE: Swap for torch.nn.LayerNorm or Python RMSNorm without Triton.
...
def get_cos_sin(seq_length, head_dim, base=500000.0):
    ...
    dtype = torch.bfloat16  # CPU/MPS NOTE: Prefer torch.float32 where bf16 is unsupported.
