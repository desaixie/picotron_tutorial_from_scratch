...
def set_all_seed(seed):
    ...
    raise NotImplementedError(
        "Propagate the seed to all relevant RNG backends."  # CPU/MPS NOTE: Only call torch.cuda.manual_seed_all() when CUDA is available and seed torch.mps if applicable.
    )
